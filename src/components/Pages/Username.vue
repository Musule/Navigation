<template>
  <div id="Home">
    ...
    <br />
    <el-dialog title="新建用户" :visible.sync="add_isDisplay" width="60%" :before-close="handleClose">
      <div>
        <el-form
          size="medium"
          :model="user_form"
        ...
        >
          ...
          <el-form-item label="用户账号" :label-width="formLabelWidth" prop="user_name">
            <el-input
              clearable
              maxlength="200"
              style="width:300px"
          ...
          <el-form-item label="权限" :label-width="formLabelWidth" prop="function_permission">
            <el-transfer
              :titles="['可选', '已选']"
              filterable
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submit_add_form('user_form')">提交</el-button>
        <el-tooltip class="item" effect="dark" content="确定要取消？" placement="top">
          <el-button @click="submit_add_form_cancel">取 消</el-button>
        </el-tooltip>
      </span>
    </el-dialog>
    <el-dialog title="编辑用户" :visible.sync="edit_isDisplay" width="60%" :before-close="handleClose">
      <div>
        <el-form
          size="medium"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submit_edit_form('user_eidt_form')">提交</el-button>
        <el-tooltip class="item" effect="dark" content="确定要取消？" placement="top">
          <el-button @click="submit_add_form_cancel">取 消</el-button>
        </el-tooltip>
      </span>
    ...
    >
      <div>
        ...
        >
          ...
          <el-form-item label="时间" :label-width="formLabelWidth" prop="user">
            <el-input
              type="textarea"
    ...
    >
      ...
      >
        ...
        <el-table-column prop="user_id" sortable label="ID" width="200" align="center"></el-table-column>
        <el-table-column prop="user_name" sortable label="用户账号" width="250" align="center"></el-table-column>
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="user_create_time" sortable label="时间" width="220" align="center"></el-table-column>
  ...
  data() {
    return {
      ...
      function_permission_data: [
        { key: 1, label: "新建网址", disabled: false },
        { key: 2, label: "编辑网址", disabled: false },
        { key: 3, label: "查询网址", disabled: false },
        { key: 4, label: "删除网址", disabled: false },
        { key: 5, label: "导出网址", disabled: false },
